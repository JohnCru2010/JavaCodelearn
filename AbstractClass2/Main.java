...
public class Main {
    public static void main (String[] args) {
       ...
       Warrior w2 = new Warrior ("Code2", "Aragorn", 10, 100, 20000, 15, 15);

       Burglar b1 = new Burglar ("Code3", "Bilbo");
       Burglar b2 = new Burglar ("Code4", "Tasslehoff", 10, 100, 20000, 15);

       Wizard wiz1 = new Wizard ("Code5", "Raistlin");
       Wizard wiz2 = new Wizard ("Code6", "Gandalf", 10, 100, 20000, 15, 100);
